...
<xsl:stylesheet xmlns:sfs="http://schema.slothsoft.net/farah/sitemap" xmlns:sfd="http://schema.slothsoft.net/farah/dictionary" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:lio="http://slothsoft.net" xmlns:func="http://exslt.org/functions"
                xmlns:set="http://exslt.org/sets" xmlns:ssh="http://schema.slothsoft.net/schema/historical-games-night" version="1.0" xmlns="http://www.w3.org/1999/xhtml"
